...
void TriangleWrapper::UploadPoints(const std::vector<Point2>& points, const std::vector<Point2>& other, const std::vector<std::pair<int, int>>& constrainedIndexes) {
...
std::vector<Triangle> TriangleWrapper::Triangulate() {
	char cmd[] = "zQ";
...
std::vector<Triangle> TriangleWrapper::TriangulateConstrained() {
	char cmd[] = "pzQ";
	triangulate(cmd, &m_In, &m_Out, (struct triangulateio*)NULL);
